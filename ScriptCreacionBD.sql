...
/*
Padres: sede, categoria, estatus, tipo, grado, puesto, rol, fotografia
Padres-Hijas: recinto, usuario, area, recursos, miembro, evento
Hijas: eventoxrecurso, eventoxmiembro, eventoxusuario, eventoxrecinto, fotografia
Subtipos; academico, alumno
*/
...
CREATE TABLE categoria(
                          ...
                          CONSTRAINT pkCategoria
                              PRIMARY KEY (idCategoria)
                                  ...
                                  CHECK IN (prioridad IN ('1', '2', '3', '4', '5')
                                  );
...
--Creacion de tablas Padres-Hijas
...
CREATE TABLE eventoxusuario(
                               ...
                               CONSTRAINT pkEventoXUsuario
                                   PRIMARY KEY (idEvento, idUsuario),

                               CONSTRAINT fkEventoXUsuarioEvento
                                   FOREIGN KEY (idEvento)
                                       REFERENCES evento (idEvento)
                                       ON DELETE RESTRICT
                                       ON UPDATE CASCADE,

                               CONSTRAINT fkEventoXUsuarioUsuario
