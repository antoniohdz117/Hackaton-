...
CREATE TABLE sede (
	idSede INTEGER GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE estatus(
	idEstatus INTEGER GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE grado(
	idGrado INTEGER GENERATED ALWAYS AS IDENTITY,
	nombre VARCHAR (20) NOT NULL,
...
CREATE TABLE recinto(
	idRecinto INTEGER GENERATED ALWAYS AS IDENTITY,
	nombre VARCHAR (80) NOT NULL,
...
CREATE TABLE evento (
	idEvento INTEGER GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE miembro(
	idMiembro INTEGER GENERATED ALWAYS AS IDENTITY,
	nombre VARCHAR (50) NOT NULL,
	paterno VARCHAR (50) NOT NULL,
	materno VARCHAR (50) NOT NULL,
...
CREATE TABLE recursos(
	idRecursos INTEGER GENERATED ALWAYS AS IDENTITY,
	nombre VARCHAR (50) NOT NULL,
...
CREATE TABLE puesto(
	idPuesto INTEGER GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE eventoxrecinto(
	idEvento INTEGER NOT NULL,
	idRecinto INTEGER NOT NULL,
	numeroSolicitud INTEGER GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE fotografia(
	idFotografia INTEGER GENERATED ALWAYS AS IDENTITY,
