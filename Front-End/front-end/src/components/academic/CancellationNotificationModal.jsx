...
const CancellationNotificationModal = ({ isOpen, onClose }) => {

    if (!isOpen) return null;

    const title = "Se ha cancelado la reservación";
    const message = "Se le notificará al administrador la cancelación";
